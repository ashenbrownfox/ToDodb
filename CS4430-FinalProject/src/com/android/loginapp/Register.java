	 ...
	 private void RegisterMe(View v)
	    {
	    	...
	    	if (user == null) {
	    		...
	    		if (user.getCount() > 0) {
	    			Toast.makeText(getApplicationContext(), "The username is already registered, please type a new username",
	  			          Toast.LENGTH_SHORT).show();
	        		user.close();
	    			return;
	    		}
	    		...
	    		if (id > 0) {
	    			...
	    			//This is where i can call the todo list right away when it is done
